...
public class LooserFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBinding.buttonLooserBack.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void addTriviaFragment() {
        TriviaFragment triviaFragment = TriviaFragment.newInstance("");
